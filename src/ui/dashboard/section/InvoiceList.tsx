...
import { ArrowRight, FileText, PlusCircle, TrendingUp } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <td className="py-3.5 px-5 text-right">
        <ArrowRight size={16} className="inline-block text-gray-600" />
      </td>
    </tr>
  );
}
...
export function InvoiceList({ onSelectInvoice, onGenerate }: InvoiceListProps) {
  ...
  const outstandingPercent = totalBilled > 0
    ? Math.round((totalOutstanding / totalBilled) * 100)
    : 0;
